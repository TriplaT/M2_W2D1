...
function esercizioExtra1(num1, num2) {
  if (
    num1 === 8 ||
    num2 === 8 ||
    num1 + num2 === 8 ||
...
function esercizioExtra2(totalShoppingCart) {
...
function esercizioExtra3(totalShoppingCart) {
  ...
  console.log("Totale da pagare con sconto Black Friday: " + totalAmount);
  return totalAmount;
}
...
function esercizioExtra4(isMale) {
